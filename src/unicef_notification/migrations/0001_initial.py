    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_name', models.CharField(blank=True, default='', max_length=255, validators=[unicef_notification.models.validate_template_name], verbose_name='Template Name')),
                ('template_data', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True, verbose_name='Template Data')),
